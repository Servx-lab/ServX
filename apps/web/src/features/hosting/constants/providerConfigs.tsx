...
export const PROVIDER_CONFIGS: Record<string, ProviderConfig> = {
  Vercel: {
    ...
    steps: [
      ...
      { title: 'Create a new token', detail: 'Click Create, name it "ServX Connection", and copy the generated token (e.g., vk1_...).' },
    ],
    defaultKeyName: 'ServX Connection',
  ...
  Render: {
    ...
    tokenPageUrl: 'https://dashboard.render.com/u/settings#api-keys', tokenPageLabel: 'Go directly to Render API Keys settings',
    ...
    guideSubtitle: 'Follow these steps to create an API Key from your Render account. You can go directly to the API Keys section on the Render Account Settings page using the link below.',
    steps: [
      { title: 'Navigate to Account settings', detail: 'Go to dashboard.render.com, click your profile avatar in the top-right corner, and select "Account Settings" from the dropdown.' },
      { title: 'Locate the API Keys section', detail: 'Scroll down to the "API Keys" section on the settings page, or use the direct settings link below.' },
      { title: 'Generate & Copy Token', detail: 'Click "Create API Key", name it "ServX Connection" to track its usage, copy the generated key starting with "rnd_", and paste it in the form on the left.' },
    ],
    defaultKeyName: 'ServX Connection',
  ...
  Railway: {
    ...
    steps: [
      ...
      { title: 'Create a new token', detail: 'Click Create Token, name it "ServX Connection", copy the generated token.' },
    ],
    defaultKeyName: 'ServX Connection',
  ...
  DigitalOcean: {
    ...
    description: 'Enter your DigitalOcean Personal Access Token to monitor Droplets, Apps, and Kubernetes clusters.',
    ...
    steps: [
      ...
      { title: 'Configure & Copy', detail: 'Name it "ServX Connection", select Read scope, click Generate Token, then copy the dop_v1_... value.' },
    ],
    defaultKeyName: 'ServX Connection',
  ...
  'Fly.io': {
    ...
    steps: [
      ...
      { title: 'Create Token', detail: 'Click Create Access Token, name it "ServX Connection", and copy the generated value.' },
    ],
    defaultKeyName: 'ServX Connection',
  ...
  Coolify: {
    ...
    steps: [
      ...
      { title: 'Generate API Key', detail: 'Go to the API Keys section and create a new key named "ServX Connection".' },
      { title: 'Copy Information', detail: 'Copy the API key and ensure you know your instance URL (e.g., https://app.coolify.io).' },
    ],
    defaultKeyName: 'ServX Connection',
    consoleUrl: 'https://app.coolify.io',
