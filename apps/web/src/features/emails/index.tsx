...
const Emails = () => {
  ...
  return (
    <PageLayout 
      ...
      subtitle="Manage your connected inboxes"
      fullWidth={true}
      headerContent={
        isConnected && (
          <div className="flex items-center gap-4">
             <Button 
                ...
                className="text-gray-500 hover:text-black hover:bg-gray-100 bg-white rounded-xl"
              >
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <Button
                    ...
                    className="w-full h-12 bg-black hover:bg-gray-900 text-white font-medium text-sm rounded-xl"
                  >
                    {isConnecting ? (
