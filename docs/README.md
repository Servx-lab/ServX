...
- **Admin & Access logic:** [Access Management](./features/access-management/logic.md), [User Search Optimization](./features/access-management/user-search-optimization.md), [Granular Resource Control](./features/access-management/granular-resource-control.md), [Supabase Permission Architecture](./features/access-management/supabase-permission-architecture.md), [UI Implementation Guide](./features/access-management/ui-implementation-guide.md)
