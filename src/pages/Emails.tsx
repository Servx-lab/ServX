...
const Emails = () => {
  ...
  const handleDisconnect = async () => {
    // We can just call an endpoint to delete the connection if needed,
    // or just clear the local state for now. Assuming we'd add a DELETE route later.
    // For now, we'll just mock the disconnect on frontend.
    setIsConnected(false);
    setEmails([]);
  };
